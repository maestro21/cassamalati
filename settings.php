<?php 
define('ADM_PASS', 'cd3feb2dc46310a8edf7cc79cbd74200');
...
define('SITE_PATH', BASE_PATH . 'cassamalati/');
define('BASE_FOLDER', '');
...
define('HOST_FOLDER', '/cassamalati');
